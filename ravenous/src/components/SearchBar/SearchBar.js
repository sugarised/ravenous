  ...
  renderSortByOptions(){
    return Object.keys(this.sortByOptions).map(
      sortByOption => {
        ...
        return <li className={this.getSortClass(sortByOptionValue)} key="{sortByOptionValue}" onClick={this.handleSortByChange.bind(this, sortByOptionValue)}>{sortByOption}</li>
      });
  }
